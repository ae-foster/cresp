...
class LARS(object):
    ...
    def __init__(self, optimizer, eta=0.02, clip=False, eps=1e-8, **kwargs):
        """
        Args:
...
class LARSHydra(LARS):
    # A Hydra-compatible version of LARS that uses SGD
    def __init__(self, params, optim_settings, **lars_settings):
        optimizer = SGD(params, **optim_settings)
        super().__init__(optimizer, **lars_settings)
